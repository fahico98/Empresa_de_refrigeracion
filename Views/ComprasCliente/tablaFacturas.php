         ...
         <div class="form-group row mx-0 my-0">
            ...
            <div class="btn-group ml-2">
               <button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown"
                  ...
                  style="width: 160px;">Fecha y hora</button>
               <div class="dropdown-menu">
                  <option value="fecha_hora" class="dropdown-item dropdownLink">Fecha y hora</option>
                  <option value="id" class="dropdown-item dropdownLink">Id</option>
               </div>
            </div>
