...
CREATE TABLE `clientes` (
  ...
  `Edad` int(3) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `login` (
  ...
  `Password` varchar(255) CHARACTER SET ucs2 COLLATE ucs2_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
--
ALTER TABLE `clientes`
  ADD CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`Placa`) REFERENCES `registro_vehiculos` (`Id`) ON UPDATE CASCADE;
